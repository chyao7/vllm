...
TORCH_LIBRARY_EXPAND(TORCH_EXTENSION_NAME, ops) {
...
#ifndef USE_ROCM
  ops.def(
      "custom_qk_rmsnorm_rope(Tensor! qkv, int num_heads_q, int num_heads_k, "
      "int num_heads_v, int head_dim, int rotary_dim, float eps, "
      "Tensor q_weight, Tensor k_weight, Tensor cos_sin_cache, bool is_neox, "
      "Tensor position_ids) -> ()");
  ops.impl("custom_qk_rmsnorm_rope", torch::kCUDA, &custom_qk_rmsnorm_rope);

  ops.def(
      "custom_qkv_proj_rmsnorm_rope(Tensor! qkv, Tensor hidden_states, "
      "Tensor qkv_weight, Tensor? qkv_bias, int num_heads_q, int num_heads_k, "
      "int num_heads_v, int head_dim, int rotary_dim, float eps, "
      "Tensor q_weight, Tensor k_weight, Tensor cos_sin_cache, bool is_neox, "
      "Tensor position_ids) -> ()");
  ops.impl("custom_qkv_proj_rmsnorm_rope", torch::kCUDA,
           &custom_qkv_proj_rmsnorm_rope);

  ops.def(
      "custom_qkj_proj_rmsnormal_reshap_cache(Tensor! qkv, Tensor hidden_states, "
      "Tensor qkv_weight, Tensor? qkv_bias, int num_heads_q, int num_heads_k, "
      "int num_heads_v, int head_dim, int rotary_dim, float eps, "
      "Tensor q_weight, Tensor k_weight, Tensor cos_sin_cache, bool is_neox, "
      "Tensor position_ids, Tensor? key_cache, Tensor? value_cache, "
      "Tensor? slot_mapping) -> ()");
  ops.impl("custom_qkj_proj_rmsnormal_reshap_cache", torch::kCUDA,
           &custom_qkj_proj_rmsnormal_reshap_cache);

  ops.def(
      "minimax_m2_fused_qkv_gemm_only("
      "Tensor! qkv, Tensor hidden_states, Tensor qkv_weight, Tensor? qkv_bias) -> ()");
  ops.impl("minimax_m2_fused_qkv_gemm_only", torch::kCUDA,
           &minimax_m2_fused_qkv_gemm_only);

  ops.def(
      "minimax_m2_fused_qkv_epilogue_sum_sq("
      "Tensor! qkv, Tensor! qk_sum_sq, Tensor? qkv_bias, "
      "int q_size, int kv_size) -> ()");
  ops.impl("minimax_m2_fused_qkv_epilogue_sum_sq", torch::kCUDA,
           &minimax_m2_fused_qkv_epilogue_sum_sq);

  ops.def(
      "minimax_m2_fused_qkv_compute("
      "Tensor! qkv, Tensor hidden_states, Tensor qkv_weight, Tensor? qkv_bias, "
      "Tensor q_norm_weight, Tensor k_norm_weight, Tensor cos_sin_cache, "
      "Tensor position_ids, int num_heads_q, int num_heads_k, int num_heads_v, "
      "int head_dim, float eps, bool is_neox, int tp_world, Tensor! qk_sum_sq, "
      "bool use_standalone_sum_epilogue=False) -> ()");
  ops.impl("minimax_m2_fused_qkv_compute", torch::kCUDA,
           &minimax_m2_fused_qkv_compute);

  ops.def(
      "minimax_m2_fused_qkv_post_fused("
      "Tensor! qkv, Tensor q_norm_weight, Tensor k_norm_weight, "
      "Tensor cos_sin_cache, Tensor position_ids, int num_heads_q, "
      "int num_heads_k, int num_heads_v, int head_dim, float eps, "
      "bool is_neox, Tensor qk_sum_sq) -> ()");
  ops.impl("minimax_m2_fused_qkv_post_fused", torch::kCUDA,
           &minimax_m2_fused_qkv_post_fused);
  ...
  ops.def(
      ...
      "Tensor cos_sin_cache, Tensor position_ids, int num_heads_q, "
      "int num_heads_k, int num_heads_v, int head_dim, float eps, "
      "bool is_neox, int tp_world, Tensor qk_sum_sq) -> ()");
  ops.impl("minimax_m2_fused_qkv_finalize", torch::kCUDA,
           &minimax_m2_fused_qkv_finalize);
